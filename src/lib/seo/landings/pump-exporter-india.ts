...
export const pumpExporterIndia: IndustrialPageContent = {
  path: "/pump-exporter-india",
  title: "Pump Exporter from India | GCC & Africa B2B Supply",
  description:
    "SUPERTECH WATER SOLUTION exports industrial pumps, motors, solar pumping components, valves, panels, pipes, and cables from India with procurement-ready documentation for UAE, Saudi Arabia, GCC, and Africa.",
  h1: "Pump exporter from India with documentation-first B2B execution",
  intro:
    "Export pumping is a documentation and logistics discipline as much as a manufacturing discipline. International buyers evaluate Indian suppliers on response clarity, inspection readiness, stable naming across invoices and packing lists, and post-award engineering availability. SUPERTECH WATER SOLUTION is structured for B2B export workflows: RFQ-led selection, configuration-specific technical communication, and dispatch planning aligned to project milestones. When competing with other Indian exporters and global brands, buyers should score suppliers on repeatability — can the same quality gates be reproduced order after order?",
  sections: [
    {
      h2: "What international procurement teams scrutinize first",
      paragraphs: [
    ...
    {
      h2: "GCC markets: UAE, Saudi Arabia, Qatar, Oman, Kuwait, Bahrain",
      paragraphs: [
    ...
    {
      h2: "Africa project supply: multimodal logistics and schedule realism",
      paragraphs: [
    ...
    {
      h2: "Product breadth: pumps, motors, solar, valves, panels, pipes, cables",
      paragraphs: [
    ...
    {
      h2: "How RFQ quality improves export quotation accuracy",
      paragraphs: [
    ...
    {
      h2: "Start an export inquiry with SUPERTECH WATER SOLUTION",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Which countries do you export pumps to?",
      answer:
        "SUPERTECH WATER SOLUTION supports export lanes across GCC countries and Africa, alongside India-wide distribution, subject to destination-specific requirements shared in the RFQ."
    },
    {
      question: "Can you provide datasheets and brochures for tender submission?",
      answer:
        "Yes. Request curated bundles via RFQ or download baseline materials from the technical resource center and brochure library."
    },
    {
      question: "Do you support factory inspection requirements?",
      answer:
        "Share inspection protocols and windows in the RFQ so quotations include realistic manufacturing and release schedules."
    },
    {
      question: "What incoterms can you support?",
      answer:
        "Incoterms depend on logistics partner arrangements and destination constraints. Specify the desired incoterm in the RFQ for aligned commercial structuring."
    }
  ],
  applications: [
