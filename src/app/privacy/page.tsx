    ...
    <div className="section-gray min-h-screen">
      <div className="container py-14 md:py-20">
        <div className="max-w-3xl">
          <div className="text-xs font-black tracking-widest text-navy-800 uppercase mb-3">Legal</div>
          <h1 className="text-3xl font-black text-navy-700 mb-6">Privacy Policy</h1>
          <div className="space-y-4 text-sm text-slate-800 leading-relaxed bg-white rounded-xl border border-gray-200 p-8 shadow-card">
            <p>
